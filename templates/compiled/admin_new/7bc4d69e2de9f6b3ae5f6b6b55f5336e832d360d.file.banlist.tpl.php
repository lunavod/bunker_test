<?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:18:59
         compiled from "/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/actions/ActionAdmin/banlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1689351272561a9a03218f89-58062808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7bc4d69e2de9f6b3ae5f6b6b55f5336e832d360d' => 
    array (
      0 => '/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/actions/ActionAdmin/banlist.tpl',
      1 => 1405860042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1689351272561a9a03218f89-58062808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_561a9a0355f165_47166302',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_561a9a0355f165_47166302')) {function content_561a9a0355f165_47166302($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include '/var/www/html/engine/modules/viewer/plugs/function.hook.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('inc.system_message.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1689351272561a9a03218f89-58062808');
content_561a9a03393a55_14247601($_smarty_tpl);
...
<h3><?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_menu_banlist;?>
</h3>
...
<div class="topic">
    ...
    <ul class="nav nav-tabs">
        ...
        <li <?php if ($_smarty_tpl->tpl_vars['sMode']->value=='ids'||$_smarty_tpl->tpl_vars['sMode']->value==''){?>class="active"<?php }?>><a href="<?php echo smarty_function_router(array('page'=>'admin'),$_smarty_tpl);?>
banlist/users/"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_banlist_ids;?>
</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['sMode']->value=='ips'){?>class="active"<?php }?>><a href="<?php echo smarty_function_router(array('page'=>'admin'),$_smarty_tpl);?>
banlist/ips/"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_banlist_ips;?>
</a></li>
    </ul>

    <?php if ($_smarty_tpl->tpl_vars['sMode']->value=='ips'){?>
        <?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['sTemplatePathAction']->value)."/banlist_ips.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

    <?php }else{ ?>
        <?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['sTemplatePathAction']->value)."/banlist_ids.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<div class="accordion-group no-border">
    <div class="accordion-heading">
        ...
        <?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_banlist_add;?>
...
"
            ...
            <label><?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_ban_period;?>
</label>
            <label class="radio">
...
"/>
            ...
            <button type="submit" name="adm_action_submit" class="btn btn-danger"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->_adm_users_ban;?>
</button>
        </form>
    </div>
</div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('toolbar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1689351272561a9a03218f89-58062808');
content_561a9a0350ce42_41944197($_smarty_tpl);
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:18:59
         compiled from "/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/inc.system_message.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a03393a55_14247601')) {function content_561a9a03393a55_14247601($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['noShowSystemMessage']->value){?>
...
:</h4>
        ...
        <?php } ?>
    <?php }?>
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:18:59
         compiled from "/var/www/html/templates/skin/reboot/toolbar.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a0350ce42_41944197')) {function content_561a9a0350ce42_41944197($_smarty_tpl) {?><aside class="toolbar">
	<?php /*  Call merged included template "blocks.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('blocks.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('group'=>'toolbar'), 0, '1689351272561a9a03218f89-58062808');
content_561a9a03514469_31324734($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "blocks.tpl" */?>
</aside><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:18:59
         compiled from "/var/www/html/templates/skin/reboot/blocks.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a03514469_31324734')) {function content_561a9a03514469_31324734($_smarty_tpl) {?><?php if (!is_callable('smarty_function_get_blocks')) include '/var/www/html/engine/modules/viewer/plugs/function.get_blocks.php';
