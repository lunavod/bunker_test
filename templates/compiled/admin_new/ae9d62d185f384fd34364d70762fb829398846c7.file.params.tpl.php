<?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:20:07
         compiled from "/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/actions/ActionAdmin/params.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1098435699561a9a474c1b26-23982866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae9d62d185f384fd34364d70762fb829398846c7' => 
    array (
      0 => '/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/actions/ActionAdmin/params.tpl',
      1 => 1405860042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1098435699561a9a474c1b26-23982866',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_561a9a478898e4_68521420',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_561a9a478898e4_68521420')) {function content_561a9a478898e4_68521420($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include '/var/www/html/engine/modules/viewer/plugs/function.hook.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('inc.system_message.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1098435699561a9a474c1b26-23982866');
content_561a9a476a1310_57256779($_smarty_tpl);
...
<h3><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_params_title;?>
</h3>
<div class=topic>
...
" />
        <p>
            <label for="param_reserved_urls"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_page_options_urls;?>
:</label>
            <input type="text" id="param_reserved_urls" name="param_reserved_urls" value="<?php echo $_smarty_tpl->tpl_vars['sParamPageUrlReserved']->value;?>
"  class="w100p" /><br />
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_page_options_urls_notice;?>
</span>
        </p>

        <p>
            <label for="param_items_per_page"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_items_per_page;?>
:</label>
            <input type="text" id="param_items_per_page" name="param_items_per_page" value="<?php echo $_smarty_tpl->tpl_vars['sParamItemsPerPage']->value;?>
"  class="w50" /><br />
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_items_per_page_notice;?>
</span>
        </p>

        <!-- p>
            <label for="param_votes_per_page"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_votes_per_page;?>
:</label>
            <input type="text" id="param_votes_per_page" name="param_votes_per_page" value="<?php echo $_smarty_tpl->tpl_vars['sParamVotesPerPage']->value;?>
"  class="w100p" /><br />
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_votes_per_page_notice;?>
</span>
        </p -->

        <!-- p>
            <label for="param_edit_footer"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_edit_footer;?>
:</label>
            <input type="text" id="param_edit_footer" name="param_edit_footer" value="<?php echo $_smarty_tpl->tpl_vars['sParamEditFooter']->value;?>
"  class="w100p" /><br />
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_edit_footer_notice;?>
</span>
        </p -->

        <p>
            <label for="param_vote_value"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_vote_value;?>
:</label>
            <input type="text" id="param_vote_value" name="param_vote_value" value="<?php echo $_smarty_tpl->tpl_vars['nParamVoteValue']->value;?>
"  class="w50" /><br />
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_vote_value_notice;?>
</span>
        </p>

        <p>
            <label class="checkbox"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_check_password;?>
:
                <input type="checkbox" id="param_check_password" name="param_check_password" value="1" <?php if (($_smarty_tpl->tpl_vars['bParamCheckPassword']->value)){?>checked<?php }?> /><br />
            </label>
            <span class="help-block"><?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_param_check_password_notice;?>
</span>
        </p>
        ...
        <div class="form-actions fix-on-container">
            <div class="navbar fix-on-bottom">
                <div class="navbar-inner">
                    <div class="container">
                        <input type="submit" name="submit_options_save" value="<?php echo $_smarty_tpl->tpl_vars['oLang']->value->adm_save;?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('toolbar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1098435699561a9a474c1b26-23982866');
content_561a9a478062e8_43774748($_smarty_tpl);
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:20:07
         compiled from "/var/www/html/plugins/aceadminpanel/templates/skin/admin_new/inc.system_message.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a476a1310_57256779')) {function content_561a9a476a1310_57256779($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['noShowSystemMessage']->value){?>
...
:</h4>
        ...
        <?php } ?>
    <?php }?>
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:20:07
         compiled from "/var/www/html/templates/skin/reboot/toolbar.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a478062e8_43774748')) {function content_561a9a478062e8_43774748($_smarty_tpl) {?><aside class="toolbar">
	<?php /*  Call merged included template "blocks.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('blocks.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('group'=>'toolbar'), 0, '1098435699561a9a474c1b26-23982866');
content_561a9a4780fbe4_24649758($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "blocks.tpl" */?>
</aside><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2015-10-11 20:20:07
         compiled from "/var/www/html/templates/skin/reboot/blocks.tpl" */ ?>
<?php if ($_valid && !is_callable('content_561a9a4780fbe4_24649758')) {function content_561a9a4780fbe4_24649758($_smarty_tpl) {?><?php if (!is_callable('smarty_function_get_blocks')) include '/var/www/html/engine/modules/viewer/plugs/function.get_blocks.php';
