 ...
 * Настройка пагинации
 */
$config['pagination']['pages']['count'] = 10;                  // количество ссылок на другие страницы в пагинации
...
$config['module']['topic']['link_max_length'] = 5000;    // Максимальное количество символов в одном топике-ссылке
$config['module']['topic']['question_max_length'] = 5000;// Максимальное количество символов в одном топике-опросе
...
$config['moderator'] = array(1, 2, 6, 14, 15, 19, 20, 21, 22, 23, 24, 25, 27, 28);
