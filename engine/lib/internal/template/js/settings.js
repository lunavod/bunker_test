	...
	this.getMarkitup = function() {
		return {
			...
			markupSet:  [
				...
				{name: ls.lang.get('panel_url'), className:'fa fa-link', key:'L', openWith:'<a href="[!['+ls.lang.get('panel_url_promt')+':!:http://]!]"(!( title="[![Title]!]")!)>', closeWith:'</a>', placeHolder:'Your text to link...' },
				{name: ls.lang.get('panel_user'), className:'fa fa-user', replaceWith:'<ls user="[!['+ls.lang.get('panel_user_promt')+']!]" />' },
				{separator:'---------------' },
				{name: ls.lang.get('spoiler-gray'), className:'fa fa-h-square', key:'G', replaceWith: function(m) { if (m.selectionOuter) return '<span class="spoiler-gray">'+m.selectionOuter+'</span>'; else if (m.selection) return '<span class="spoiler-gray">'+m.selection+'</span>'; else return '<span class="spoiler-gray"></span>' } },
				{name: ls.lang.get('spoiler'), className:'fa fa-caret-square-o-down', key:'R', replaceWith: function(m) { if (m.selectionOuter) return '<span class="spoiler"><span class="spoiler-title spoiler-close">' + prompt('Спойлер', "Спойлер") + '</span><span class="spoiler-body">\n'+m.selectionOuter+'\n</span></span>'; else if (m.selection) return '<span class="spoiler"><span class="spoiler-title spoiler-close">' + prompt('Спойлер', "Спойлер") + '</span><span class="spoiler-body">\n'+m.selection+'\n</span></span>'; else return '<span class="spoiler"><span class="spoiler-title spoiler-close">' + prompt('Спойлер', "Спойлер") + '</span><span class="spoiler-body">\nтекст спойлера\n</span></span>'} },
				{separator:'---------------' },
